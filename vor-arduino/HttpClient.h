...
// FIXME Update tempToPachube example to calculate Content-Length correctly
    ...
    */
    int post(const char* aServerName,
      ...
      { return startRequest(aServerName, aServerPort, aURLPath, HTTP_METHOD_POST, aUserAgent, contentType, body); }
    ...
    */
    int post(const IPAddress& aServerAddress,
             ...
             const char* contentType = NULL,
             const char* body = NULL)
      { return startRequest(aServerAddress, aServerName, aServerPort, aURLPath, HTTP_METHOD_POST, aUserAgent, contentType, body); }
    ...
    */
    int post(const IPAddress& aServerAddress,
             ...
             const char* contentType = NULL,
             const char* body = NULL)
      { return startRequest(aServerAddress, aServerName, kHttpPort, aURLPath, HTTP_METHOD_POST, aUserAgent, contentType, body); }
